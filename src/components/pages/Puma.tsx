...
import pumaModel1 from './../../assets/puma/AdiFOM_TRXN_Shoes_Black_IG7453_01_standard.webp'
import pumaModel2 from './../../assets/puma/Superstar_XLG_Shoes_Black_IG9777_01_standard.webp'
import pumaModel3 from './../../assets/puma/PostMove_Mid_Cloudfoam_Super_Lifestyle_Basketball_Mid_Classic_Shoes_Black_GY7163_01_standard.webp'
        ...
        <div>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
                {pumaArr.map((puma, index) => (
                    <Link key={puma.id} to={`/adidas/${puma.id}`}>
                        <img
                            src={puma.picture}
                            alt={puma.model}
